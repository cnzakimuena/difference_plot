# Difference Plot
Script to generate a difference plot. The plot uses the chick weight dataset for demonstration. 

The publication featuring the dataset used for demonstration (Crowder & Hand, 1990) and the publications used for confirming weight units (Knížetová et al, 1991; Roberts, 1964) are listed below:
